...
The `base` folder is for DurableActivities.pipeline configuration, such as non-sensitive and project-related configuration that may be DurableActivities.pipeline across team members.
